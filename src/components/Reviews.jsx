...
const reviewData = [{ name: "Charlie Brown", rev:"This OCR data extraction tool is a game-changer. It's incredibly accurate and saves me hours of manual data entry. Highly recommended!"},
  ...
  { name: "Kachra Seth", rev: "The accuracy of this OCR tool is simply astounding. It can extract data from even the most complex documents. The user interface is also very user-friendly." },
  { name: "Baburao", rev: "I've tried many OCR tools, but this one stands out. The accuracy is unmatched, and it's incredibly fast. It has made my work much more efficient." },
  { name: "Raju", rev: "This OCR tool is excellent. It's not only accurate but also very efficient. It has saved me a lot of time and effort. I highly recommend it." },
  { name: "Harry Potter", rev: "The precision of this OCR tool is amazing. It can extract data from various types of documents with ease. It's an essential tool for anyone dealing with a lot of paperwork." }
];

      ...
      >
        <div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-start">
          ...
          <motion.div
            ...
            className="flex flex-col gap-6 mt-16 md:mt-80 md:text-5xl text-3xl font-bold text-white max-w-[600px] w-auto h-auto"
          >
            <span>
              Providing
          ...
          <motion.div variants={slideInFromBottom(1.5)}>
            <Link to="/home">
              <label
                className="md:text-3xl text-2xl m-auto md:px-16 px-4
        ...
        >
          {isMobile ? (
            ...
            <div className="flex flex-col items-center text-lg mt-36 text-gray-400">
              <QRCodeComponent />
              <br />
              <p>
